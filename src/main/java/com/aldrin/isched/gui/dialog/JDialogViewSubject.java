 ...
 */
public class JDialogViewSubject extends javax.swing.JDialog {

    private JFrameMain jFrameMain;
    private Long subjectId;

    public JDialogViewSubject(JFrameMain parent, boolean modal, Long subjectId) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(595, 405));
  ...
  //   ID, SUBJECT, CODE,INSTRUCTOR, DAY, TIME, ROOM 
    DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "SUBJECT", "SECTION", "INSTRUCTOR", "DAY", "TIME", "ROOM"}, 0) {
...
//   ID, SUBJECT, CODE,INSTRUCTOR, DAY, TIME, ROOM 
    ...
    private void selectSubject(Long subjectId) {
        tableModel.setRowCount(0);
        scheduleList = scheduleDAOImpl.selectScheduleBySubjectId(subjectId);
        tableModel.setRowCount(0);
        for (Schedule s : scheduleList) {
            tableModel.addRow(new Object[]{s.getId(), s.getSubject().getSubject(), s.getSection().getCode(), s.getInstructor().getInstructor(), s.getDay().getDay(), s.getTime().getTime(), s.getRoom().getRoom()});
        }
    }
