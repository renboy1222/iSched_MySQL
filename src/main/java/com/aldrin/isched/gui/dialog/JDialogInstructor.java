...
import com.aldrin.isched.gui.dialog.au.JDialogInstructorAU;
...
public class JDialogInstructor extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogInstructor(JFrameMain jFrameRegister, boolean modal) {
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogInstructorAU semesterAU = new JDialogInstructorAU(jFrameMain, true);
        semesterAU.setVisible(true);
        selectInstructor();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogInstructorAU semesterAU = new JDialogInstructorAU(jFrameMain, true, instructor, "Update");
        semesterAU.setVisible(true);
        selectInstructor();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogInstructorAU semesterAU = new JDialogInstructorAU(jFrameMain, true, "Delete", instructor);
        semesterAU.setVisible(true);
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "INSTRUCTOR"}, 0);
    ...
    private InstructorDAOImpl dayDAOImpl = new InstructorDAOImpl();
    private ArrayList<Instructor> dayList;

    private void selectInstructor() {
        tableModel.setRowCount(0);
        dayList = dayDAOImpl.selectInstructor();
        tableModel.setRowCount(0);
        for (Instructor ins : dayList) {
            tableModel.addRow(new Object[]{ins.getId(), ins.getInstructor()});
        }
        ...
        if (e.getSource() == jTableInstructor) {
            if (e.getButton() == MouseEvent.BUTTON1) {
                if (e.getClickCount() == 1) {
                    ...
                    if (row != -1) {
                        Long userId = Long.parseLong(jTableInstructor.getValueAt(row, 0).toString());
                        String instructor = jTableInstructor.getValueAt(row, 1).toString();
