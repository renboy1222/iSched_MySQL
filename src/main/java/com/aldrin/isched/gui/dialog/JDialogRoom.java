...
import com.aldrin.isched.gui.dialog.au.JDialogRoomAU;
...
public class JDialogRoom extends javax.swing.JDialog implements MouseListener {
    ...
    public JDialogRoom(JFrameMain jFrameRegister, boolean modal) {
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        JDialogRoomAU categoryAU = new JDialogRoomAU(jFrameMain, true);
        categoryAU.setVisible(true);
        selectRoom();
    }//GEN-LAST:event_jButtonNewActionPerformed

    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        JDialogRoomAU categoryAU = new JDialogRoomAU(jFrameMain, true, room, "Update");
        categoryAU.setVisible(true);
        selectRoom();
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        JDialogRoomAU categoryAU = new JDialogRoomAU(jFrameMain, true, "Delete", room);
        categoryAU.setVisible(true);
        jButtonDelete.setEnabled(false);
        jButtonUpdate.setEnabled(false);
  ...
  DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "ROOM"}, 0);
    ...
    private void selectRoom() {
        ...
        tableModel.setRowCount(0);
        for (Room r : roomList) {
            tableModel.addRow(new Object[]{r.getId(), r.getRoom()});
        }
