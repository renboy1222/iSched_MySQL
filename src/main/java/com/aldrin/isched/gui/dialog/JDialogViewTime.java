 ...
 */
public class JDialogViewTime extends javax.swing.JDialog {

    private JFrameMain jFrameMain;
    private Long timeId;

    public JDialogViewTime(JFrameMain parent, boolean modal, Long timeId) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(595, 408));
...
//   ID, DAY, TIME, CODE, SUBJECT,INSTRUCTOR, ROOM 
    DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "TIME", "DAY", "SECTION", "SUBJECT", "INSTRUCTOR", "ROOM"}, 0) {
...
//        jTableSubject.addMouseListener(this);
        ...
        column[1].setPreferredWidth(180);

        column[3] = jTableSubject.getColumnModel().getColumn(2);
...
//   ID, TIME, DAY, CODE, SUBJECT,INSTRUCTOR, ROOM 

    private void selectTime(Long timeId) {
        tableModel.setRowCount(0);
        scheduleList = scheduleDAOImpl.selectScheduleByTimeId(timeId);
        tableModel.setRowCount(0);
        for (Schedule s : scheduleList) {
            tableModel.addRow(new Object[]{s.getId(), s.getTime().getTime(), s.getDay().getDay(), s.getSection().getCode(), s.getSubject().getSubject(), s.getInstructor().getInstructor(), s.getRoom().getRoom()});
        }
    }
