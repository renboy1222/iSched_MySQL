 ...
 */
public class JDialogViewInstructor extends javax.swing.JDialog {

    private JFrameMain jFrameMain;
    private Long instructorId;

    public JDialogViewInstructor(JFrameMain parent, boolean modal, Long instructorId) {
        super(parent, modal);
  ...
  //   ID, SUBJECT, CODE,INSTRUCTOR, DAY, TIME, ROOM 
    DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "INSTRUCTOR", "SUBJECT", "SECTION", "DAY", "TIME", "ROOM"}, 0) {
...
//        jTableSubject.addMouseListener(this);
        ...
        column[1].setPreferredWidth(220);
...
//   ID,INSTRUCTOR, SUBJECT, CODE, DAY, TIME, ROOM 

    private void selectInstructor(Long instructorId) {
        tableModel.setRowCount(0);
        scheduleList = scheduleDAOImpl.selectScheduleByInstructorId(instructorId);
        tableModel.setRowCount(0);
        for (Schedule s : scheduleList) {
            tableModel.addRow(new Object[]{s.getId(), s.getInstructor().getInstructor(), s.getSubject().getSubject(), s.getSection().getCode(), s.getDay().getDay(), s.getTime().getTime(), s.getRoom().getRoom()});
        }
    }
