...
public class JDialogChangePassword extends javax.swing.JDialog {
     ...
     */
    public JDialogChangePassword(com.aldrin.isched.gui.JFrameMain main, boolean modal, UserAccount userAccount) {
        super(main, modal);
        initComponents();
        this.jFrameMain = main;
    ...
    private void jButtonChangePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonChangePasswordActionPerformed
        ...
        int response = JOptionPane.showConfirmDialog(jFrameMain, "Are you sure to change your password?", "Change password confirmation", JOptionPane.YES_NO_OPTION);
        if (response == JOptionPane.YES_OPTION) {
            if (userAccountDAOImpl.changePassword(userAccount) == true) {
                JOptionPane.showMessageDialog(jFrameMain, "Password is successfully change.", "Message", JOptionPane.PLAIN_MESSAGE);
                this.dispose();
            }
        }
