 ...
 */
public class JDialogViewDay extends javax.swing.JDialog {

    private JFrameMain jFrameMain;
    private Long dayId;

    public JDialogViewDay(JFrameMain parent, boolean modal, Long dayId) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(595, 371));
...
//   ID, DAY, TIME, CODE, SUBJECT,INSTRUCTOR, ROOM 
    DefaultTableModel tableModel = new DefaultTableModel(new Object[]{"ID", "DAY", "TIME", "SECTION", "SUBJECT", "INSTRUCTOR", "ROOM"}, 0) {
...
//   ID, DAY, TIME, CODE, SUBJECT,INSTRUCTOR, ROOM 
    ...
    private void selectDay(Long dayId) {
        tableModel.setRowCount(0);
        scheduleList = scheduleDAOImpl.selectScheduleByDayId(dayId);
        tableModel.setRowCount(0);
        for (Schedule s : scheduleList) {
            tableModel.addRow(new Object[]{s.getId(), s.getDay().getDay(), s.getTime().getTime(), s.getSection().getCode(), s.getSubject().getSubject(), s.getInstructor().getInstructor(), s.getRoom().getRoom()});
        }
    }
